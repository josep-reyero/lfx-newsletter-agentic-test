...
// In every deployed environment the chart sets this to the API gateway origin
// without a service-specific prefix — e.g. "https://lfx-api.v2.cluster.lfx.dev"
// — because /newsletters/unsubscribe is exposed at the gateway root. Trailing
// slashes are trimmed.
